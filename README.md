...
# 主工作流 v8.9.8 可选更新：
## 🎯 更新日志：
- 混合放大的细节增强部分，改写PAG注意力引导（SEG节点有BUG，改不了模糊强度），PAG强度2，噪声注入默认强度降低到0.2（大麻对这个强度相对敏感，其他模型可以看情况自己调高，也可以保持默认）
- AI提示词处理部分，修正内核更新后导致节点无响应的BUG，默认渠道改成grok（可自行修改，deepseek实在是有点慢受不了了），添加一个简洁的AI助手提示词，可以用于改写、扩写、和全新生成提示词
```
...
# 🛑 打开工作流前先删除汉化包插件【AIGODLIKE-ComfyUI-Translation】 删除它后，请务必【重启ComfyUI】，然后【重新下载工作流】并打开它
- 秋叶管理器自带这个插件，请务必 **【删除它】**
- 这个汉化包已被其作者**放弃**，**不兼容新**版内核，会导致我的所有自定义设置节点名称**被还原**，设置分区将变得不明所以！所以你**必须删除它**！


##  🥰 工作流进阶使用指南：
 ❓ [**如何正确开启梯子的TUN模式**](https://discord.com/channels/1134557553011998840/1292880055193567263/1340881769595142226)
 ❓ [**如何使用WeiLin提示词编辑插件**](https://discord.com/channels/1134557553011998840/1292880055193567263/1340881902101598209)
 ❓ [**如何正确使用功能分区管理**](https://discord.com/channels/1134557553011998840/1292880055193567263/1340888460608667658)
 ❓ [**如何串联多个底图控制网**](https://discord.com/channels/1134557553011998840/1292880055193567263/1360636403842678977)


## 🔗 **主工作流下载（正常玩文生图下这个）**
**⬇️ 最新版主工作流 (v8.9.8)：**
https://discord.com/channels/1134557553011998840/1292880055193567263/1363507737874661417
**工作流配套的细化模型：**
[需要的细化YOLO模型](https://discord.com/channels/1134557553011998840/1292880055193567263/1345442225194274817)
[需要的细化SAM模型](https://discord.com/channels/1134557553011998840/1292880055193567263/1345445426513313904)


##  💬 酒馆独立版下载（玩酒馆文生图脚本的下这个）
**🛑 酒馆版使用须知：**
- 酒馆版本使用流程[见图](https://discord.com/channels/1134557553011998840/1292880055193567263/1348206688238309439)
- 氛围参考版本额外需求详见[从前佬的教程](https://gxcgf4l6b2y.feishu.cn/docx/CLOsdtZl3oyzfGx4pNucDeLInHR#Ytx3dkIE4ocVF2x2zt1ckcjSnle)
- 质量版需要主工作流使用须知里的细化模型，请务必下载
- （独立更新 配合从前佬的文生图脚本食用）
- 每个下载链接都会有两个文件，一个是API文件（复制到酒馆问生图设置里用的），一个是原工作流文件（用于拖到ComfyUI来测试工作流能否正常运行，是否缺失插件等）
- 如果鬼图，请到文生图脚本设置里把【正向预设】改为【False】（默认为Ture），负面预设改为【无】（默认为作者预设）

**⬇️ 酒馆工作流下载指路（四选一下载 ）：**
【4月14补充一个[需要手动安装的插件地址](https://github.com/weilin9999/WeiLin-ComfyUI-prompt-all-in-one) 作者最近把这个插件从manager下掉了，manager已经无法自动检测它】
[极速 无氛围参考](https://discord.com/channels/1134557553011998840/1292880055193567263/1348205240431804467)
[极速 有氛围参考 不知道氛围参考是什么就别下！](https://discord.com/channels/1134557553011998840/1292880055193567263/1348205442844852225)
[质量 无氛围参考](https://discord.com/channels/1134557553011998840/1292880055193567263/1348205582896594965)
[质量 有氛围参考 不知道氛围参考是什么就别下！](https://discord.com/channels/1134557553011998840/1292880055193567263/1348205627452686448)



## 📚 其他教程:
➡️ [ComfyUI 中文自动补全](https://discord.com/channels/1134557553011998840/1310246496741884005)
➡️ [Krita 联动 ComfyUI 进行高级涂鸦重绘](https://discord.com/channels/1134557553011998840/1294864645080879156)
➡️ [Cherry Studio + DeepSeek 生成 SD 绘图提示词](https://discord.com/channels/1134557553011998840/1336904184674648167)


# 🤓 AI绘图新手推荐教程：https://discord.com/channels/1134557553011998840/1327838280254754836

# 历史更新记录：
<details>
<summary>主工作流 v8.9 更新</summary>
# 主工作流 v8.9 更新
## 更新日志：
- 移除TIPO（BUG太多了，包括不识别embedding、不识别weilin lora、重复添加同类特征、安装困难等...）
- 加入AI提示词处理可选功能（你可以自己选择要调用哪家的AI，可以自己自定义助手提示词）
- WD14反推注释修改，加入原址和模型下载流程指南
- 提示词黑名单移除（有BUG，而且我还找不到怎么修）
- 图像保存现在有两个版本（一个带元数据一个不带元数据，默认改成开启不带元数据的版本，带元数据的保存节点目前有BUG，要用的把对应插件回退到上个版本）
- 提示词处理部分整理
- 注释补充
- 排版整理
</details>
<details>
<summary>主工作流 v8.8 更新</summary>
# 主工作流 v8.8 更新
## 更新日志：
- 将所有保存图像的节点改为可以保存元数据的节点（C站可识别，法术解析网站可识别）
- 底图、混合放大、通用放大、SD放大增加保存图像的开关
- 放大和细化的调度器改为kl_optimal（V预测模型对karras过于敏感了）
- 步数统一为30
- 默认关闭混合放大第一阶段的lora隔离，要的自己打开
- 添加了更多指示工作流功能分区的Label
- 注释补充
</details>
<details>
<summary>主工作流 v8.7 更新</summary>
# 主工作流 v8.7 更新：
## - 此次更新添加了WD14提示词反推、TIPO提示词扩写、Tag类别黑名单功能，需要安装额外的插件，使用Manager检测缺失安装即可
## - ⚠️反推和扩写在第一次使用时都需要在后台下载需要的模型，请开启梯子和TUN模式，模型下载进度可在秋叶启动项控制台查看
（反推模型大概300MB左右，扩写模型大概1G左右）
## 更新日志：
- WD14提示词反推、TIPO提示词扩写、Tag类别黑名单功能
- 提示词处理和WeiLin-Lora加载单独分区
- 放大步数降低到25
- 注释补充，排版整理
- 添加额外的Label用来指示分区
## 💫 目前工作流中的正面提示词组合流程为：
提示词前缀+反推词（如果有的话）+weilin提示词
⬇️
扩写（如果开启的话）
⬇️
附加提示词后缀
...
<details>
<summary>主工作流 v8.5.9 更新</summary>
# 主工作流 v8.5.9 更新：
更新日志：
- 提示词编辑节点改回旧版，新版反响太差
- Lora堆应用节点暴露，方便连接
...
<details>
<summary>主工作流 v8.5.7 更新（推荐更新）</summary>
# 主工作流 v8.5.7 更新（推荐更新）
## 上个版本的更新日志（很重要，推荐观看）：
