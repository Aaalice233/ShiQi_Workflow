...
## 🔗 **主工作流导航（正常玩文生图下这个）**
**最新版主工作流 (v8.5.9)：**
https://discord.com/channels/1134557553011998840/1292880055193567263/1358006985018052770
**工作流配套的细化模型：**
...
**🛑 酒馆版使用须知：**
- ⚠️ 酒馆版本使用流程[见图](https://discord.com/channels/1134557553011998840/1292880055193567263/1348206688238309439)
- ⚠️`氛围参考版本额外需求`详见[从前佬的教程](https://gxcgf4l6b2y.feishu.cn/docx/CLOsdtZl3oyzfGx4pNucDeLInHR#Ytx3dkIE4ocVF2x2zt1ckcjSnle)
- ⚠️`质量版`需要主工作流使用须知里的`细化模型`，请务必下载
- （独立更新 配合从前佬的文生图脚本食用）
- 每个下载链接都会有`两个文件`，一个是`API文件（复制到酒馆问生图设置里用的）`，一个是`原工作流文件（用于拖到ComfyUI来测试工作流能否正常运行，是否缺失插件等）`
